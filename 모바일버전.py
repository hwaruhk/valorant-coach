...
# --- 섹션 1: STRATEGY ---
st.markdown('<div class="category-box"><div class="category-title">STRATEGY</div><div class="btn-row">', unsafe_allow_html=True)
...
# --- 섹션 2: OPENING ---
st.markdown('<div class="category-box"><div class="category-title">OPENING DUALS</div>', unsafe_allow_html=True)
...
with f2:
    ...
    st.markdown('</div>', unsafe_allow_html=True)
st.markdown('</div><div class="btn-row">', unsafe_allow_html=True)
f3, f4 = st.columns(2)
with f3:
    if st.button("FD 승리", key="f3"): d['fd_w'] += 1; d['deaths'] += 1; st.rerun()
with f4:
    st.markdown('<div class="red-btn">', unsafe_allow_html=True)
...
# --- 섹션 3: COMBAT ---
st.markdown('<div class="category-box"><div class="category-title">TEAM COMBAT</div><div class="btn-row">', unsafe_allow_html=True)
t1, t2 = st.columns(2)
with t1:
